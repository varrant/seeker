...
<div class="index groundGray" v-iscroll="iscrollConf">
  <div class="scoll-layer">
    <div class="job-index-search">
      <div class="job-index-search-left">
      ...
      <div class="job-index-search-center">
        <div class="search-box"><input type="text" placeholder="搜索您需要的信息"></div>
      </div>
      <div class="job-index-search-right">
    ...
    <div class="index_list">
      ...
      <div class="job-index-list_top">
        <div class="icon-box">
           <div class="icon-box-background">
             <i class="iconfont icon-shezhi"></i>
           </div>
          
        </div>
        <div class="list-text">
          <p class="list-text-title">任务领取意向设置</p>
          <p>告诉我们你的兴趣，给你想要的任务</p>
        </div>
      </div>
      <div class="list_li">
            ...
            <ul title="tab-container 1">
              <li v-for="partItem in partList" key="partItem" @click="toTaskDetail(partItem)">
                <div class="list_word">
                  ...
                  <h3><span class="ico-part">兼职</span>{{partItem.name}}<span class="price">{{partItem.commission}}元</span></h3>
                  <p class="introduce">{{partItem.job_description}}</p>
                  <div class="list_num">
                    <span>需求：{{partItem.person_demand}}人</span>
                    <div class="list_view">
                      <a href="javascript:void(0);">
                        <i class="iconfont icon-shangchuanjianli small-icon icon-grey"></i>
                        {{partItem.recv_cv_times}}
                      </a>
                      <a href="javascript:void(0);">
            ...
            <ul title="tab-container 2">
              <li v-for="practiceItem in practiceList" key="practiceItem" @click="toTaskDetail(practiceItem)">
                <div class="list_word">
                  ...
                  <h3><span class="ico-fieldwork">实习</span>{{practiceItem.name}}<span class="price">{{practiceItem.commission}}元</span></h3>
                  ...
                  <div class="list_num">
                    ...
                    <div class="list_view">
                      <a href="javascript:void(0);">
                        <i class="iconfont icon-shangchuanjianli small-icon icon-grey"></i>
                        {{practiceItem.recv_cv_times}}
                      </a>
                      <a href="javascript:void(0);">
                        <i class="iconfont icon-chakan small-icon icon-grey"></i>
                        {{practiceItem.view_times}}
                      </a>
                    </div>
                  </div>
                </div>
            ...
            <ul title="tab-container 3">
              <li v-for="fullTimeItem in fullTimeList" key="fullTimeItem" @click="toTaskDetail(fullTimeItem)">
                <div class="list_word">
                  ...
                  <h3><span class="ico-full">全职</span>{{fullTimeItem.name}}<span class="price">{{fullTimeItem.commission}}元</span></h3>
                  ...
                  <div class="list_num">
                    ...
                    <div class="list_view">
                      <a href="javascript:void(0);">
                        <i class="iconfont icon-shangchuanjianli small-icon icon-grey"></i>
                        {{fullTimeItem.recv_cv_times}}
                      </a>
                      <a href="javascript:void(0);">
                        <i class="iconfont icon-chakan small-icon icon-grey"></i>
                        {{fullTimeItem.view_times}}
                      </a>
                    </div>
                  </div>
                </div>
